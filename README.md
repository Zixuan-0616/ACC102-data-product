...
| `volatility_by_size.png` | Bar chart comparing volatility by firm size |
| `firm_volatility_trend.png` | Time series of rolling volatility for a sample firm (PERMNO 10026) |
| `volatility_summary.csv` | Descriptive statistics by size group |
| `README.md` | This file |
...
## Demo Video
[Link to your demo video – 1-3 minutes, unlisted]